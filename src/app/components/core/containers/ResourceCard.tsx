...
const ResourceCard = ({ resourceId, resourceUrl, title, description, imgUrl, owner, isLiked, favCount, kinds }: ResourceCardProps) => {
	return (
		<article className='show-card relative flex flex-col min-w-[320px] gap-5 items-center p-2 bg-white border border-zinc-100 shadow-sm rounded-5xl'>
